...
static const wchar_t TAK_CHQ_EEPROM_FILENAME[] = L"tak_chq-eeprom.sav";
...
static const wchar_t EPO_HAMC_STATE_FILENAME[] = L"epo_hamc-runtime-state.sav";
static const wchar_t TVPC_HAM_EEPROM_FILENAME[] = L"tvpc_ham-eeprom.sav";
...
static const wchar_t *filename_for_kind(enum drgqst_persistence_kind kind)
{
	...
	case DRGQST_PERSISTENCE_TAK_CHQ_EEPROM:
		return TAK_CHQ_EEPROM_FILENAME;
	case DRGQST_PERSISTENCE_TAK_CHQ_RUNTIME_STATE:
		return TAK_CHQ_STATE_FILENAME;
	case DRGQST_PERSISTENCE_EPO_EBOX_NVRAM:
	...
	case DRGQST_PERSISTENCE_EPO_HAMC_RUNTIME_STATE:
		return EPO_HAMC_STATE_FILENAME;
	case DRGQST_PERSISTENCE_TVPC_HAM_EEPROM:
		return TVPC_HAM_EEPROM_FILENAME;
	case DRGQST_PERSISTENCE_TVPC_HAM_RUNTIME_STATE:
		return TVPC_HAM_STATE_FILENAME;
	case DRGQST_PERSISTENCE_TVPC_HK_EEPROM:
	...
	case DRGQST_PERSISTENCE_EPO_MINI_EEPROM:
	...
	size_t error_length)
{
	if (kind == DRGQST_PERSISTENCE_EEPROM ||
		...
		kind == DRGQST_PERSISTENCE_EPO_MINI_EEPROM)
	{
	...
	if (kind == DRGQST_PERSISTENCE_TVPC_DOR_EEPROM ||
		kind == DRGQST_PERSISTENCE_TVPC_HAM_EEPROM ||
		kind == DRGQST_PERSISTENCE_TVPC_HK_EEPROM)
	{
	...
	if (kind == DRGQST_PERSISTENCE_EPO_SDB_NVRAM ||
		kind == DRGQST_PERSISTENCE_EPO_EBOX_NVRAM)
	{
