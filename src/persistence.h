...
enum
{
	...
	DRGQST_PERSISTENCE_EEPROM24C04_SIZE = 512,
...
enum drgqst_persistence_kind
{
	...
	DRGQST_PERSISTENCE_EPO_DAB2J_RUNTIME_STATE = 42,
	DRGQST_PERSISTENCE_EPO_DTCJ_RUNTIME_STATE = 43,
	DRGQST_PERSISTENCE_EPO_PABJ_RUNTIME_STATE = 44,
	DRGQST_PERSISTENCE_EPO_SSK2_RUNTIME_STATE = 45,
	DRGQST_PERSISTENCE_EPO_SSKJ_RUNTIME_STATE = 46,
	DRGQST_PERSISTENCE_EPO_DTCJ_EEPROM = 47,
	DRGQST_PERSISTENCE_EPO_SSK2_EEPROM = 48,
	DRGQST_PERSISTENCE_EPO_SSKJ_EEPROM = 49
};
