...
enum
{
	...
	DRGQST_PERSISTENCE_EEPROM24C02_SIZE = 256,
...
enum drgqst_persistence_kind
{
	...
	DRGQST_PERSISTENCE_RAD_MTRK_RUNTIME_STATE = 50,
	DRGQST_PERSISTENCE_RAD_SNOW_RUNTIME_STATE = 51,
	DRGQST_PERSISTENCE_RAD_SSX_RUNTIME_STATE = 52,
	DRGQST_PERSISTENCE_RAD_SBW_RUNTIME_STATE = 53,
	DRGQST_PERSISTENCE_TAK_GIN_RUNTIME_STATE = 54,
	DRGQST_PERSISTENCE_TCARNAVI_RUNTIME_STATE = 55,
	DRGQST_PERSISTENCE_TOMTHR_RUNTIME_STATE = 56,
	DRGQST_PERSISTENCE_EPO_CROK_EEPROM = 57,
	DRGQST_PERSISTENCE_EPO_CROK_RUNTIME_STATE = 58,
	DRGQST_PERSISTENCE_TAK_ZUBA_EEPROM = 59,
	DRGQST_PERSISTENCE_TAK_ZUBA_RUNTIME_STATE = 60,
	DRGQST_PERSISTENCE_DUELMAST_EEPROM = 61,
	DRGQST_PERSISTENCE_DUELMAST_RUNTIME_STATE = 62,
	DRGQST_PERSISTENCE_EPO_GOLF_EEPROM = 63,
	DRGQST_PERSISTENCE_EPO_GOLF_RUNTIME_STATE = 64
};
